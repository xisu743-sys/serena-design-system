...
| 强调色 | `--accent` | `#2B7FD8` | 超链、重点下划线、CTA、选中态、流程节点 |
| 强调深色 | `--accent-deep` | `#1E5BA8` | 大装饰字、section数字编号、深蓝信息块 |
| 点缀色 | `--decor` | `#CC2936` | badges、异常信号、少量高亮、装饰标记 |
| 点缀深色 | `--decor-deep` | `#A81F2B` | 红色点缀的深色版本，少量使用 |
| 奶白底 | `--cream` | `#FFFDF9` | 页面主背景 |
| 深奶底 | `--cream-dark` | `#F9F8F6` | section间交替背景 |
...
- 主色永远是主色，强调色负责行动与信息清晰度，点缀色只做少量记忆点
- 背景用径向渐变制造层次感，不要纯平色
...
10. **全宽品牌色面板**: 背景优先使用主色/强调色纯色，文字反白；点缀色只用于小面积警示或标记。一页最多1~2个，用于打破奶白底的节奏。禁忌：不要在品牌色面板上放同色文字
